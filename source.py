...
try:
    ...
    body = "************* -----Uber----- ****************"
    sender_email = "sudeepkulkarni29@gmail.com"
    password = "qrqeivdysilbxqbg"
    ...
    if route_to_find in routes.keys() and ctype in fare.keys():
        ...
        if yn_lower=='yes':
            ...
            if promo_code == 'yes':
                ...
                pdf.cell(w=0,h=5,txt = "************************ Uber Ride Receipt ***********************",align="C")
                pdf.multi_cell(w=0,txt="  ",ln=1)
                pdf.set_font('helvetica', size=20)
                pdf.multi_cell(w=0,txt="  ",ln=1)
                pdf.multi_cell(w=0,txt=f"* Ride No : {rde}",ln=1)
                pdf.multi_cell(w=0,txt="  ",ln=1)
                pdf.multi_cell(w=0,txt=f"* Date : {dte}          Time : {tme}",ln=1)
                pdf.multi_cell(w=0,txt="  ",ln=1)
                pdf.multi_cell(w=0,txt=f"* Passenger Name : {name}",ln=1)
                pdf.multi_cell(w=0,txt="  ",ln=1)
                pdf.multi_cell(w=0,txt=f"* Passenger Email-ID : {gemail}",ln=1)
                pdf.multi_cell(w=0,txt="  ",ln=1)
                pdf.multi_cell(w=0,txt=f"* Passender Mobile Number : {mob}",ln=1)
                pdf.multi_cell(w=0,txt="  ",ln=1)
                pdf.multi_cell(w=0,txt=f"* Base Fare : Rs.{base_fare}",ln=1)
                pdf.multi_cell(w=0,txt="  ",ln=1)
                pdf.multi_cell(w=0,txt=f"* Total Fare {base_fare} without promo",ln=1)
                pdf.multi_cell(w=0,txt="  ",ln=1)
                pdf.multi_cell(w=0,txt=f"* Total Fare : Rs.{(base_fare+((base_fare*0.09)+(base_fare*0.09)))-(base_fare*0.20)}",ln=1)
                pdf.multi_cell(w=0,txt="  ",ln=1)
                pdf.multi_cell(w=0,txt=f"* `Includes 9% CGST and 9%SGST (T&C)`",ln=1)
                pdf.multi_cell(w=0,txt="  ",ln=1)
                pdf.multi_cell(w=0,txt=f"* Thanks For Riding with Us",ln=1)
                pdf.multi_cell(w=0,txt="  ",ln=1)
    ...
    print(ex)
    #print(f"No Ride Available at this Instance !") 
